...
#define CS_LOW()	PORTB &= ~4		/* CS=low */
#define	CS_HIGH()	PORTB |= 4		/* CS=high */
...
/*-----------------------------------------------------------------------*/
/* Power Control  (ATMega88/168/328)                                     */
/*-----------------------------------------------------------------------*/
...
void power_off (void)
{
	...
	// MOSI : PB3 -- In, hi-z
	// SS   : PB2 -- In, hi-z
	DDRB  &= 0b11000011;	/* Set SCK/MOSI/CS as hi-z */
	PORTB &= 0b11000011;
...
/*-----------------------------------------------------------------------*/
/* Transmit/Receive data from/to MMC via SPI  (ATMega88/168/328)         */
/*-----------------------------------------------------------------------*/
...
{
	if (pdrv) return STA_NOINIT | STA_NODISK;	/* Supports only single drive */
	return Stat;
}
