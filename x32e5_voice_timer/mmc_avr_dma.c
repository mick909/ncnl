/*-----------------------------------------------------------------------*/
/* MMCv3/SDv1/SDv2 Controls via AVR USART-SPI                            */
/*-----------------------------------------------------------------------*/
/*
...
#define CS_LOW()	PORTC.OUTCLR = PIN0_bm;		/* CS=low */
#define	CS_HIGH()	PORTC.OUTSET = PIN0_bm;		/* CS=high */

#define FCLK_SLOW()	USARTC0.BAUDCTRLA = 63;		/* Slow clock = 100kHz */
#define FCLK_FAST() USARTC0.BAUDCTRLA = 0;		/* Fast clock = FCPU / 2 */
